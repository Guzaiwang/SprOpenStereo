...
from .igev_stereo import IGEVStereo_agg as IGEVStereo
from modeling.models.loss2 import FocalLoss
import cv2
import warnings
...
class IGEVLoss:
    ...
    def __call__(self, training_output):
        ...
        aug_gt = training_disp['aug_reg']



        init_disp, disp_preds, aug_ests = pred_disp

        loss = self.sequence_loss_aux(disp_preds, init_disp, disp_gt, aug_gt, aug_ests, mask.float())
